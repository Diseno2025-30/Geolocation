...
        // Añadimos 'radiuses=500;500' para que OSRM "atrape" los puntos
        // aunque estén lejos de la calle (hasta 500m), como en tu screenshot.
        const url = `${basePath}/osrm/route/${lon1},${lat1};${lon2},${lat2}?overview=full&geometries=geojson&radiuses=500;500`;
